...
This TypeScript script for AltV Roleplay servers allows players to save their current position in the game with a command and return to it later.
...
Project Link: [https://github.com/30Msearchtime/altv-save-position-script](https://github.com/30Msearchtime/altv-save-position-script)
